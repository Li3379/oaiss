...
result = subprocess.run(
    ["curl", "-s", "-X", "POST", "http://localhost:8080/api/v1/auth/login",
     ...
     "-d", '{"username":"reviewer001","password":"admin123"}'],
...
# Navigate to reviewer home - audit list
goto_url("http://localhost:5173/auditor/audit/list")
time.sleep(3)
wait_for_load()
capture_screenshot("test-screenshots/tc-03-01-reviewer-audit-list")
print(page_info())
