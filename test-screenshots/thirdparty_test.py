...
# Login as thirdparty001
result = subprocess.run(
    ["curl", "-s", "-X", "POST", "http://localhost:8080/api/v1/auth/login",
     "-H", "Content-Type: application/json",
     "-d", '{"username":"thirdparty001","password":"admin123"}'],
...
# Navigate to third-party home - monitor
goto_url("http://localhost:5173/third-party/monitor")
time.sleep(3)
wait_for_load()
capture_screenshot("test-screenshots/tc-05-01-thirdparty-monitor")
print(page_info())
