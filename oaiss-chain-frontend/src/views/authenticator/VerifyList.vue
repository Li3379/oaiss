<template>
  <PageContainer :title="t('verifyList.title')">
    ...
    <el-card class="section-card" shadow="never">
      <div class="search-row">
        <el-select v-model="statusFilter" :placeholder="t('verifyList.colStatus')" clearable style="width: 150px">
          <el-option :label="t('verifyList.statusPending')" value="PENDING" />
          <el-option :label="t('verifyList.statusApproved')" value="APPROVED" />
          <el-option :label="t('verifyList.statusRejected')" value="REJECTED" />
        </el-select>
    ...
    <el-card class="section-card" shadow="never">
      <el-table :data="reports" :loading="loading" border :empty-text="t('verifyList.emptyText')">
        ...
        <el-table-column prop="reportNo" :label="t('verifyList.colReportNo')" min-width="120" />
        ...
        <el-table-column prop="totalEmission" :label="t('verifyList.colTotalEmission')" min-width="120" />
...
const getStatusLabel = (status) => {
  const map = { DRAFT: t('verifyList.statusDraft'), PENDING: t('verifyList.statusPending'), APPROVED: t('verifyList.statusApproved'), REJECTED: t('verifyList.statusRejected') }
