...
-- 示例认证机构
INSERT INTO `user` (`id`, `username`, `password`, `email`, `phone`, `real_name`, `user_type`, `status`, `created_at`, `updated_at`)
VALUES (6, 'authenticator001', '$2a$10$hBOIu5glgwd4b8ohK/K/mOCFTZmHnDBskNnzr9ngA5J6jFCH57Vva', 'authenticator001@example.com', '13800138005', '钱认证', 5, 1, NOW(), NOW());

INSERT INTO `authenticator` (`id`, `user_id`, `org_name`, `org_code`, `address`, `contact_person`, `contact_phone`, `cert_scope`, `status`, `created_at`, `updated_at`)
VALUES (1, 6, '中国质量认证中心', 'CQC001', '北京市朝阳区朝外大街甲10号', '钱认证', '13800138005', '["碳排放核查","碳中和认证","碳信用验证"]', 1, NOW(), NOW());
